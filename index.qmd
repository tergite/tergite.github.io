...
::: {layout-ncol=2}
![](./assets/img/cnl-logo.svg){.light height=100}
![](./assets/img/cnl-logo-light.svg){.dark height=100}

![](./assets/img/cth-logo-emblem.svg){.light height=100}
![](./assets/img/cth-logo-emblem-light.svg){.dark height=100}
:::
...
::: {layout-ncol=3}
![](./assets/img/kaw.svg){.light height=300}
![](./assets/img/kaw-light.svg){.dark height=300}

![](./assets/img/neic-logo.svg){.light height=300}
![](./assets/img/neic-logo-light.svg){.dark height=300}

![](./assets/img/eu-logo.svg){.light height=300}
![](./assets/img/eu-logo-light.svg){.dark height=300}
:::
