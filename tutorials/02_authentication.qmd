...
- Open the [`tergite-frontend/apps/tergite-landing-page/src/app/api/config/route.ts`](../src/app/api/config/route.ts) file and update its `OAUTH2_LOGOS` list to include your new provider's logo.
