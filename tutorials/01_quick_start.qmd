...
public_key_path = "/code/bcc_certs/q2-pub-key.pem"
...
```zsh
mkdir -p bcc_certs
openssl genpkey -algorithm RSA -out q2-priv-key.pem -pkeyopt rsa_keygen_bits:4096
openssl rsa -pubout -in q2-priv-key.pem -out bcc_certs/q2-pub-key.pem
BCC_PRIVATE_KEY_PATH="$(pwd)/q2-priv-key.pem"
...
control_rz_lambda = 0.6
target_rz_lambda = 0.3
