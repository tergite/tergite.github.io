...
::: {layout-ncol=1}
![](../assets/img/quick_start/mongo-compass-new-connection.png)
:::

- Create a new mongo database called "testing" that contains a "backends" collection.

::: {layout-ncol=1}
![](../assets/img/quick_start/mongo-compass-new-database-collection.png)
:::

- Click on "ADD DATA" then "Insert document" in your "backends" collection in your mongo compass

::: {layout-ncol=1}
![](../assets/img/quick_start/mongo-compass-add-new-backend.png)
:::
...
::: {layout-ncol=1}
![](../assets/img/quick_start/mongo-compass-insert-copied-backend.png)
:::
